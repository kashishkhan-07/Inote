  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {[1, 2, 3, 4, 5, 6].map((item) => (
        <div
          key={item}
          className="bg-white rounded-2xl p-6 border border-slate-100 shadow-xs animate-pulse flex flex-col justify-between h-56"
        >
          <div>
            {/* Title Placeholder */}
            ...
            <div className="space-y-2">
              ...
              <div className="h-3.5 bg-slate-100 rounded-sm w-2/3"></div>
            </div>
          </div>
